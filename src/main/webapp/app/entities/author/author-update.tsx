  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="poloApp.author.home.createOrEditLabel" data-cy="AuthorCreateUpdateHeading">
            <Translate contentKey="poloApp.author.home.createOrEditLabel">Create or edit a Author</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : authorEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="author-name" data-cy="name" type="text" name="name" />
              </AvGroup>
              <AvGroup>
                <Label id="birthDateLabel" for="author-birthDate">
                  <Translate contentKey="poloApp.author.birthDate">Birth Date</Translate>
                </Label>
                <AvField id="author-birthDate" data-cy="birthDate" type="date" className="form-control" name="birthDate" />
              </AvGroup>
