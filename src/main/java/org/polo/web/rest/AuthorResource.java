...
/**
 * REST controller for managing {@link org.polo.domain.Author}.
 */
@RestController
@RequestMapping("/api")
public class AuthorResource {
    ...
    public ResponseEntity<AuthorDTO> updateAuthor(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, authorDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<AuthorDTO> partialUpdateAuthor(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, authorDTO.getId())
        );
    }
